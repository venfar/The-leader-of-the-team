...
define config.name = _("Лидер команды: Испытание руководителя")
...
define build.name = "Theleaderoftheteam"
...
define config.save_directory = "Theleaderoftheteam-1700659126"

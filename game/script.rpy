...
label act_2:
    ...
    emily "Вот это просто потррудительно, [ggname]! Это действительно великолепные новости. Наша команда работала настолько усердно, и теперь мы получаем заслуженное признание."
